# Omnipay: Seamlesschex

**Seamlesschex gateway for the Omnipay PHP payment processing library**
...
``` bash
$ composer require league/omnipay knightar/omnipay-seamlesschex
```
...
If you believe you have found a bug, please report it using the [GitHub issue tracker](https://github.com/knightar/omnipay-seamlesschex/issues),
...
If you discover any security related issues, please email brandon@ihub.global instead of using the issue tracker.

## Credits

- [KnightAR](https://github.com/knightar)
